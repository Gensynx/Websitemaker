/* Generates the static HTML pages. Run from the 381-accountants-premium folder:
...
const pages = [
  ...
  },
  {
    ...
    desc: 'Contact 381 Accountants: 020 8214 1259 · info@381abs.com · 30 Churchill Place, Canary Wharf, London E14 5RE. Open Mon–Fri 9:00–17:30. Book your free consultation with the three-step wizard.',
    active: 'contact',
    body: contactBody,
    jsonld: BUSINESS_LD,
  },
