...
- **Coveworks scifi** — `coveworks-scifi/` folder, the flagship edition with a floating theme switcher (scifi and editorial cuts in one file, see `coveworks-scifi/README.md`)
